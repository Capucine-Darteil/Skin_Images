import os
from scripts.data import get_data, merge_dicts, resize_data, flat_images, df_final
...
def load_data(CHEMIN_1,CHEMIN_2,CHEMIN_METADATA):
...
if __name__ == '__main__':
    load_data(CHEMIN_1,CHEMIN_2,CHEMIN_METADATA)
